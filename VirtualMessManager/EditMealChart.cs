...
namespace VirtualMessManager
{
    public partial class EditMealChart : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'vMMDataSet2.vmmMealChart' table. You can move, or remove it, as needed.
            this.vmmMealChartTableAdapter2.Fill(this.vMMDataSet2.vmmMealChart);
        ...
        {
            if (gv_EditMealSheet.CurrentCell.ColumnIndex.Equals(7))
            {
            ...
            else if (gv_EditMealSheet.CurrentCell.ColumnIndex.Equals(8))
            {
                try
                {
                    ...
                    if (MessageBox.Show("Are you Sure want to Update this records ?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                       ...
                       // Data Source = DESKTOP - GHDL7O6\\SQLEXPRESS; Initial Catalog = VMM; User ID = 'sa'; Password = '12345'"
                        con.Open();
                        SqlDataAdapter sda1 = new SqlDataAdapter("Select * from vmmMealSheet", con);
                        DataTable dt = new DataTable();
                        SqlCommandBuilder scb = new SqlCommandBuilder(sda1);
                        sda1.Update(this.vMMDataSet2.vmmMealChart);
                        con.Close();
        ...
        private void gv_EditMealSheet_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (gv_EditMealSheet.CurrentCell.ColumnIndex.Equals(8))
            {
                if (MessageBox.Show("Are you Sure want to delete this records ?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    var row = gv_EditMealSheet.CurrentRow;
        ...
        private void gv_EditMealSheet_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (gv_EditMealSheet.CurrentCell.ColumnIndex.Equals(7))
            {
                try
                {
