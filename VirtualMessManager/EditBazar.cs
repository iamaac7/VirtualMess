...
namespace VirtualMessManager
{
    public partial class EditBazar : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'vMMDataSet3.vmmBazarChart' table. You can move, or remove it, as needed.
            this.vmmBazarChartTableAdapter2.Fill(this.vMMDataSet3.vmmBazarChart);
        ...
        private void gv_EditBazat_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
